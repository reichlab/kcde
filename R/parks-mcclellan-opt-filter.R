...
initialize_filter_params_pm_opt_filter <- function(prev_phi,
    ...
    new_phi$multilogit_f_c_0 <- log(default_f_c_0) - multilogit_denom
...
update_filter_params_from_vectorized_pm_opt_filter <- function(phi_est_vector, phi) {
    ...
    ## f_c_1 = f_c_0 + b
    log_denom <- logspace_sum(c(0, phi$multilogit_f_c_0, phi$multilogit_f_c_1_minus_f_c_0))
